...
class TankAI:
    ...
    def N(self):
        return (self.board[x_pos  ,y_pos-2]==WALL) or 
               (self.board[x_pos-1,y_pos-2]==WALL) or 
               (self.board[x_pos+1,y_pos-2]==WALL)

    def E(self):
        return (self.board[x_pos+2,y_pos  ]==WALL) or 
               (self.board[x_pos+2,y_pos-1]==WALL) or 
               (self.board[x_pos+2,y_pos+1]==WALL)
